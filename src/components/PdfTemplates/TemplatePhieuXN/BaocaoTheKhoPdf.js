...
#the-kho .center-thong-tin-thuoc {
  display:flex;
  flex-direction:column;
    width: 35%;
}
...
const TheKho = ({ data }) => {
  ...
  return (
    <div id="the-kho">
      ...
      <div className="title"> {i18n.t(languageKeys.the_kho)}</div>
      ...
      <div className="thong-tin-thuoc first-thong-tin">
        <div className="left-thong-tin-thuoc">
          <div>
            {i18n.t(languageKeys.field_ten_thuoc)}: {data.thuoc.Thuoc_Ten}
          </div>
          <div>
            {i18n.t(languageKeys.field_Don_vi)} : {data.thuoc.Thuoc_Dvt}
          </div>
          <div>
            {i18n.t(languageKeys.field_Hoat_chat)} : {data.thuoc.Thuoc_HoatChat}
          </div>
        </div>
        <div className="center-thong-tin-thuoc">
          <div>
            {i18n.t(languageKeys.field_ma_thuoc)} : {data.thuoc.Thuoc_Code}
          </div>
          <div>
            {i18n.t(languageKeys.field_ham_luong)} : {data.thuoc.HAM_LUONG}
          </div>
          <div>
            {i18n.t(languageKeys.field_quy_cach_dong_goi)}: {data.thuoc?.QUYCACH_DONGGOI}
          </div>
        </div>
        <div className="right-thong-tin-thuoc">
          <div>
            {i18n.t(languageKeys.so_dang_ky)}: {data.thuoc.SO_DANG_KI }
          </div>
          <div>
            {i18n.t(languageKeys.field_nong_do)}: {data.thuoc.NONG_DO}
          </div>
        </div>
      </div>
      ...
      <table className="table">
        <tr>
          <th rowspan="2">
            {i18n.t(languageKeys.data_Ngay)} {i18n.t(languageKeys.data_Thang)}
          </th>
          ...
          <th colspan="3">{i18n.t(languageKeys.txt_So_luong)}</th>

          {/* <th rowspan="2">Ghi chú</th> */}
          <th rowspan="2">{i18n.t(languageKeys.trang_thai)}</th>
      ...
      <div className="footer">
        <div className="footer-chu-ky"> {i18n.t(languageKeys.nguoi_lap_bang)}</div>
        <div className="footer-chu-ky">
          {i18n.t(languageKeys.field_Truong_khoa)} {i18n.t(languageKeys.loai_khoa_duoc)}
        </div>
        <div className="footer-chu-ky">
