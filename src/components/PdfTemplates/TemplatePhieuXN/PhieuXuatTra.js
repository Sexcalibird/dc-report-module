...
export const stylePhieuXuatTra = `
...
#phieu-xuat-tra .title { text-transform: uppercase; font-size: 2rem; font-weight: bold; margin-top: 1.5rem; margin-bottom: 1rem; text-align: center; }
...
@media print {
   #phieu-xuat-tra .foot-break { break-inside: avoid; }
}
`;

const PhieuXuatTra = ({ data = {} }) => {
  ...
  return (
    <div id="phieu-xuat-tra">
      ...
      <div className="title">{i18n.t(languageKeys.loai_phieu_xuat_tra_ncc).toUpperCase()}</div>
...
export default memo(PhieuXuatTra);
